...
$.reject = function(options) {
	...
	element.find('#jr_inner li').css({ // Browser list items (li)
		background: 'transparent url("'+opts.imagePath+'background_browser.png") no-repeat 0 0'
	});
	console.log('transparent url("'+opts.imagePath+'background_browser.png") no-repeat 0 0');
