/*
 ...
 $A.publish
 $A.publish( msg [, data [, options] ] ) Returns: true on success, false if any subscriber has thrown a js exception

 $A.subscribe
 $A.subscribe( msg, func )
 $A.subscribe( msg, options, func )
 $A.subscribe( msg, options, context, func ) Returns: subscription id or [id1,id2] if subscribing to multiple messages

 $A.unsubscribe
 $A.unsubscribe( subscription_id )

 $A.resubscribe
 $A.resubscribe( subscription_id )
...
var $A = (function(){
	...
	var create_arbiter = function(){
		...
		return {
			'version'        : '1.0', 'updated_on' : '2011-12-19', 'create' : function(){
